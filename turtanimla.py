...
# Form implementation generated from reading ui file 'turtanimlas.ui'
#
...
class Ui_TurTanimla(object):
    def setupUi(self, TurTanimla):
        TurTanimla.setObjectName("TurTanimla")
        TurTanimla.resize(356, 296)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/keçi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        TurTanimla.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(TurTanimla)
        self.gridLayout.setObjectName("gridLayout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.acceptbuton = QtWidgets.QPushButton(TurTanimla)
        ...
        self.mainmenubuton = QtWidgets.QPushButton(TurTanimla)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exitbuton = QtWidgets.QPushButton(TurTanimla)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.result = QtWidgets.QLabel(TurTanimla)
        font = QtGui.QFont()
        ...
        self.retranslateUi(TurTanimla)
        QtCore.QMetaObject.connectSlotsByName(TurTanimla)
        TurTanimla.setTabOrder(self.mainmenubuton, self.exitbuton)

    def retranslateUi(self, TurTanimla):
        _translate = QtCore.QCoreApplication.translate
        TurTanimla.setWindowTitle(_translate("TurTanimla", "Keçi Türü Tanımla"))
        self.label.setText(_translate("TurTanimla", "Türün Adını Giriniz"))
