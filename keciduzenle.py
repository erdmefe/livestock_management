...
# Form implementation generated from reading ui file 'keciduzenles.ui'
#
...
class Ui_KeciDuzenle(object):
    def setupUi(self, KeciDuzenle):
        KeciDuzenle.setObjectName("KeciDuzenle")
        KeciDuzenle.resize(1031, 600)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/keçi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        KeciDuzenle.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(KeciDuzenle)
        self.gridLayout.setObjectName("gridLayout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.acceptbuton = QtWidgets.QPushButton(KeciDuzenle)
        ...
        self.mainmenubuton = QtWidgets.QPushButton(KeciDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exitbuton = QtWidgets.QPushButton(KeciDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.goatshow = QtWidgets.QLabel(KeciDuzenle)
        ...
        self.result = QtWidgets.QLabel(KeciDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.goatList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.goatList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.goatList.setHorizontalHeaderItem(6, item)
        self.gridLayout.addWidget(self.goatList, 0, 0, 5, 1)
        self.refreshbuton = QtWidgets.QPushButton(KeciDuzenle)
        icon4 = QtGui.QIcon()
        ...
        self.retranslateUi(KeciDuzenle)
        QtCore.QMetaObject.connectSlotsByName(KeciDuzenle)
        KeciDuzenle.setTabOrder(self.acceptbuton, self.exitbuton)

    def retranslateUi(self, KeciDuzenle):
        _translate = QtCore.QCoreApplication.translate
        KeciDuzenle.setWindowTitle(_translate("KeciDuzenle", "Keçi Düzenle"))
        item = self.goatList.horizontalHeaderItem(0)
        item.setText(_translate("KeciDuzenle", "Keçi ID"))
        item = self.goatList.horizontalHeaderItem(1)
        item.setText(_translate("KeciDuzenle", "Baba ID"))
        item = self.goatList.horizontalHeaderItem(2)
        item.setText(_translate("KeciDuzenle", "Anne ID"))
        item = self.goatList.horizontalHeaderItem(3)
        item.setText(_translate("KeciDuzenle", "Doğum Tarihi"))
        item = self.goatList.horizontalHeaderItem(4)
        item.setText(_translate("KeciDuzenle", "Cinsiyeti"))
        item = self.goatList.horizontalHeaderItem(5)
        item.setText(_translate("KeciDuzenle", "Cinsi"))
        item = self.goatList.horizontalHeaderItem(6)
        item.setText(_translate("KeciDuzenle", "Aşım Zamanı"))
        self.refreshbuton.setText(_translate("KeciDuzenle", "Yenile"))
