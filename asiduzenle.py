...
# Form implementation generated from reading ui file 'asiduzenles.ui'
#
...
class Ui_AsiDuzenle(object):
    def setupUi(self, AsiDuzenle):
        AsiDuzenle.setObjectName("AsiDuzenle")
        AsiDuzenle.resize(676, 464)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/keçi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        AsiDuzenle.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(AsiDuzenle)
        self.gridLayout.setObjectName("gridLayout")
        self.goatshow = QtWidgets.QLabel(AsiDuzenle)
        ...
        self.acceptbuton = QtWidgets.QPushButton(AsiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainmenubuton = QtWidgets.QPushButton(AsiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exitbuton = QtWidgets.QPushButton(AsiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.goatList = QtWidgets.QTableWidget(AsiDuzenle)
        ...
        self.result = QtWidgets.QLabel(AsiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.refreshbuton = QtWidgets.QPushButton(AsiDuzenle)
        icon4 = QtGui.QIcon()
        ...
        self.retranslateUi(AsiDuzenle)
        QtCore.QMetaObject.connectSlotsByName(AsiDuzenle)
        AsiDuzenle.setTabOrder(self.acceptbuton, self.exitbuton)

    def retranslateUi(self, AsiDuzenle):
        _translate = QtCore.QCoreApplication.translate
        AsiDuzenle.setWindowTitle(_translate("AsiDuzenle", "Aşı Bilgisi Düzenle"))
        self.goatList.setSortingEnabled(True)
        item = self.goatList.horizontalHeaderItem(0)
        item.setText(_translate("AsiDuzenle", "Keçi ID"))
        item = self.goatList.horizontalHeaderItem(1)
        item.setText(_translate("AsiDuzenle", "Aşı"))
        item = self.goatList.horizontalHeaderItem(2)
        item.setText(_translate("AsiDuzenle", "Tarih"))
        self.refreshbuton.setText(_translate("AsiDuzenle", "Yenile"))
