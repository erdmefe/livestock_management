...
# Form implementation generated from reading ui file 'sutverimiduzenles.ui'
#
...
class Ui_SutVerimiDuzenle(object):
    def setupUi(self, SutVerimiDuzenle):
        SutVerimiDuzenle.setObjectName("SutVerimiDuzenle")
        SutVerimiDuzenle.resize(800, 480)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/keçi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SutVerimiDuzenle.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(SutVerimiDuzenle)
        self.gridLayout.setObjectName("gridLayout")
        self.goatshow = QtWidgets.QLabel(SutVerimiDuzenle)
        ...
        self.acceptbuton = QtWidgets.QPushButton(SutVerimiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainmenubuton = QtWidgets.QPushButton(SutVerimiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exitbuton = QtWidgets.QPushButton(SutVerimiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.result = QtWidgets.QLabel(SutVerimiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.goatList = QtWidgets.QTableWidget(SutVerimiDuzenle)
        ...
        self.refreshbutton = QtWidgets.QPushButton(SutVerimiDuzenle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.retranslateUi(SutVerimiDuzenle)
        QtCore.QMetaObject.connectSlotsByName(SutVerimiDuzenle)
        SutVerimiDuzenle.setTabOrder(self.acceptbuton, self.exitbuton)

    def retranslateUi(self, SutVerimiDuzenle):
        _translate = QtCore.QCoreApplication.translate
        SutVerimiDuzenle.setWindowTitle(_translate("SutVerimiDuzenle", "Süt Verimi Düzenle"))
        self.goatList.setSortingEnabled(True)
        item = self.goatList.horizontalHeaderItem(0)
        item.setText(_translate("SutVerimiDuzenle", "Keçi ID"))
        item = self.goatList.horizontalHeaderItem(1)
        item.setText(_translate("SutVerimiDuzenle", "Kilo"))
        item = self.goatList.horizontalHeaderItem(2)
        item.setText(_translate("SutVerimiDuzenle", "Tarih"))
        self.refreshbutton.setText(_translate("SutVerimiDuzenle", "Yenile"))
